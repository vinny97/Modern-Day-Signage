...
import * as adminHardwareOrders from './views/admin-hardware-orders.js';
...
function route() {
  ...
  } else if (hash.startsWith('#/admin/hardware')) {
    currentView = adminHardwareOrders;
    adminHardwareOrders.render(app);
  } else if (hash === '#/admin') {
    currentView = admin;
    admin.render(app);
